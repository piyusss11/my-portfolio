...
const ProjectBox:FC<Project> = ({id, title, description, image, githubLink, liveLink, videoLink}) => {
  ...
  return (
    <div key={id}
    style={{ backgroundImage: `url(${image})`}} className={`card bg-transparent bg-center bg-contain bg-no-repeat w-[280px] h-[240px] relative overflow-hidden group rounded-lg`}>
